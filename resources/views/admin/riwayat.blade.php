<x-layouts.admin title="Riwayat Transaksi" :admin="$admin">
    ...
    <section class="ns-card mt-4 overflow-hidden">
            ...
            <table class="w-full min-w-[1050px] text-sm">
                <thead class="bg-[#f8f1df] text-left text-[10px] uppercase tracking-wide text-[#695b51]">
                    <tr>
                        ...
                        <th class="w-[8%] px-4 py-4 text-center">Aksi</th>
                    </tr>
                </thead>
        ...
        <footer class="flex items-center justify-between px-6 py-4 text-xs text-[#695b51]">
            ...
            <span class="flex items-center gap-1">&lsaquo; <b class="rounded bg-[#92591f] px-3 py-2 text-white">1</b> <span class="px-1">2</span> <span class="px-1">3</span> <span class="px-1">&hellip;</span> <span class="px-1">{{ $stats['totalPages'] ?? '26' }}</span> &rsaquo;</span>
        </footer>
    </section>
